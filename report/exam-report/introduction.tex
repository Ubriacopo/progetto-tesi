...
In particular, we aim to investigate whether distillation in a multimodal context where sources and target do not belong to the same modality is of benefit to the training pipeline or not.
To answer this question, we pretrain an instance of \textit{EEGAVI} and analyze its performance using CBraMod as a reference point.
