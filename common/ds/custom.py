...
class CustomAudioTransforms:
    """
    For clarity, I partitioned the classes others so that it's easier to understand if a custom one
    is for one modality or for another. Here we have audio transforming classes.
    """

    class ToMono:
        """
        Transforms an audio source from Stereo or any other format to MONO. (One single wave)
        """
...
class CustomVideoTransforms:
    """
    For clarity, I partitioned the classes others so that it's easier to understand if a custom one
    is for one modality or for another. Here we have video transforming classes.
    """
