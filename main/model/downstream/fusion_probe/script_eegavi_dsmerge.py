...
def main(cfg: FusionConfig):
    ...
    model_name = "AMIGOS-EAV-merge-probe-" + str(cfg.seed)
    ...
    trainer = lightning.Trainer(
        ...
        callbacks=[
            ...
            ModelCheckpoint(dirpath="checkpoints", filename=f"best-merge-{cfg.seed}", every_n_epochs=1, save_top_k=1,
    ...
    trainer.test(module, datamodule=datamodule, ckpt_path=f"checkpoints/best-merge-{cfg.seed}.ckpt")
