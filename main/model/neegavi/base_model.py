"""
    ...
    - Se EEG valido a tempo T=4 (4 secondi)
        Allora posso fare attn su t_vid quando t_vid > 3 e t_vid <6 (Vedo anche cose del futuro!)
        Allora posso fare attn su t_aud quando t_aud > 3 e t_aud <4 (qui circa)

        Dovrei anche vedere cose del passato? Essendo un EEG ha senso che quello che provo deriva
        da tempi passati? Non diventa troppo il contesto? Potrei usare una window...
