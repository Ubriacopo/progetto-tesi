...
def main(cfg: KdConfig):
    ...
    ckpt_path = "/home/jacopo/PycharmProjects/progetto-tesi/main/model/script/outputs/moco-fixed-first-train/2026-02-13_16-38-34/checkpoints/stepstep=52000.ckpt"
    module = EegAviKdVateMaskedSemiSupervisedModule.load_from_checkpoint(
        ckpt_path,
        student=student,
        teacher=teacher,
